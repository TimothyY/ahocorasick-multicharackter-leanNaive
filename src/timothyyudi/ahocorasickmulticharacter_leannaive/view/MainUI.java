package timothyyudi.ahocorasickmulticharacter_leannaive.view;
...
import timothyyudi.ahocorasickmulticharacter_leannaive.controller.AhoCorasick;
import timothyyudi.ahocorasickmulticharacter_leannaive.controller.Utility;
...
//		String asset_Home = "src/timothyyudi/ahocorasick/asset/"; //to run anywhere
		...
		try {
			...
			case "below20_400":
				...
				output_PreProcessTimeURI = output_Home+"AhoCorasick_MC_PreProcessTime_Below20_400.txt";
				output_InProcessTimeURI = output_Home+"AhoCorasick_MC_InProcessTime_Below20_400.txt";
				output_ProcessMemoryURI = output_Home+"AhoCorasick_MC_ProcessMemory_Below20_400.txt";
				break;
			case "below20_600":
				f = new File(asset_Home+"below20_0600.txt");
				output_PreProcessTimeURI = output_Home+"AhoCorasick_MC_PreProcessTime_Below20_600.txt";
				output_InProcessTimeURI = output_Home+"AhoCorasick_MC_InProcessTime_Below20_600.txt";
				output_ProcessMemoryURI = output_Home+"AhoCorasick_MC_ProcessMemory_Below20_600.txt";
				break;
			case "below20_800":
				f = new File(asset_Home+"below20_0800.txt");
				output_PreProcessTimeURI = output_Home+"AhoCorasick_MC_PreProcessTime_Below20_800.txt";
				output_InProcessTimeURI = output_Home+"AhoCorasick_MC_InProcessTime_Below20_800.txt";
				output_ProcessMemoryURI = output_Home+"AhoCorasick_MC_ProcessMemory_Below20_800.txt";
				break;
			case "below20_1000":
			...
			case "above20_200":
				...
				output_PreProcessTimeURI = output_Home+"AhoCorasick_MC_PreProcessTime_Above20_200.txt";
				output_InProcessTimeURI = output_Home+"AhoCorasick_MC_InProcessTime_Above20_200.txt";
				output_ProcessMemoryURI = output_Home+"AhoCorasick_MC_ProcessMemory_Above20_200.txt";
				break;
			case "above20_400":
				f = new File(asset_Home+"above20_0400.txt");
				output_PreProcessTimeURI = output_Home+"AhoCorasick_MC_PreProcessTime_Above20_400.txt";
				output_InProcessTimeURI = output_Home+"AhoCorasick_MC_InProcessTime_Above20_400.txt";
				output_ProcessMemoryURI = output_Home+"AhoCorasick_MC_ProcessMemory_Above20_400.txt";
				break;
			case "above20_600":
				f = new File(asset_Home+"above20_0600.txt");
				output_PreProcessTimeURI = output_Home+"AhoCorasick_MC_PreProcessTime_Above20_600.txt";
				output_InProcessTimeURI = output_Home+"AhoCorasick_MC_InProcessTime_Above20_600.txt";
				output_ProcessMemoryURI = output_Home+"AhoCorasick_MC_ProcessMemory_Above20_600.txt";
				break;
			case "above20_800":
				f = new File(asset_Home+"above20_0800.txt");
				output_PreProcessTimeURI = output_Home+"AhoCorasick_MC_PreProcessTime_Above20_800.txt";
				output_InProcessTimeURI = output_Home+"AhoCorasick_MC_InProcessTime_Above20_800.txt";
				output_ProcessMemoryURI = output_Home+"AhoCorasick_MC_ProcessMemory_Above20_800.txt";
				break;
			case "above20_1000":
				f = new File(asset_Home+"above20_1000.txt");
				output_PreProcessTimeURI = output_Home+"AhoCorasick_MC_PreProcessTime_Above20_1000.txt";
				output_InProcessTimeURI = output_Home+"AhoCorasick_MC_InProcessTime_Above20_1000.txt";
				output_ProcessMemoryURI = output_Home+"AhoCorasick_MC_ProcessMemory_Above20_1000.txt";
				break;
			case "kjvcustom":
				f = new File(asset_Home+"snortruleskeyword4000.txt");
